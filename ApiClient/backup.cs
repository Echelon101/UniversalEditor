...
namespace ApiClientBackup
{
    ...
    class backup
    {
        ...
        {
            HttpResponseMessage response = await client.PutAsJsonAsync($"api/articles/{product.Id}", product);
            response.EnsureSuccessStatusCode();
        ...
        {
            HttpResponseMessage response = await client.DeleteAsync($"api/articles/{id}");
